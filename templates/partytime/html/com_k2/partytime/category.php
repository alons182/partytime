	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListSubCategories">
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.number_format(100/$this->params->get('subCatColumns'), 1).'%;"'; ?>>
				<a href="<?php echo $subCategory->link; ?>" class="subCategory category">
					<?php if($this->params->get('subCatImage') && $subCategory->image): ?>
					<!-- Subcategory image -->
					<figure>
						<img src="<?php echo $subCategory->image; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($subCategory->name); ?>">
					</figure>
					<?php endif; ?>
